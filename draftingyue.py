...
if __name__ == "__main__":
    ...
    for i in range(num):
        ...
        wp_county=column6.selectbox("区县", list(location_dict1[wp_prov][wp_city].keys()),index=list(location_dict1[start_prov][start_city].index(start_county),key='wp_county'+str(i))
